...
- Visit-clears acks: seeing an agent's window — active, attached, and the
  terminal app focused — silences its done/waiting color everywhere until
  a new status event (`src/acks.ts`).
