return {
  ...
  keys = {
    -- Override LazyVim's diagnostic navigation to not auto-open float windows
    -- This only applies when tiny-inline-diagnostic is enabled
    {
      "[d",
      function()
  ...
  opts = {
    ...
    options = {
      ...
      multilines = {
        ...
        always_show = false, -- if true it will show all diagnostics, not just the one the cursor is on
