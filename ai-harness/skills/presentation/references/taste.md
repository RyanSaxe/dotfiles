...
- Choose the visual that shows the relationship fastest: flow, sequence, before/after, hierarchy, overlap, dependency, magnitude, risk, mitigation, ownership, or tradeoff.
...
- The gallery is a taste calibration set, not a taxonomy and not a component library.
- Look at the gallery to remember range, spacing, hierarchy, and examples of meaningful visuals.
- Do not copy a gallery slide unless the user explicitly asks for that exact shape.
- When building a new slide, start from the slide's job and content relationship, then design the visual.
